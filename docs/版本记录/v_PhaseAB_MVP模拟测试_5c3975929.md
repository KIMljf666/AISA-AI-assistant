...
| 角色 | MBTI | Baseline | Full | 提升 |
|------|------|----------|------|------|
| mvp_37 | ENTP/玄幻 | 5.0* | 5.0* | 0% (校准前) |
| mvp_37 | ENTP/玄幻 | - | 3.0 | 校准后基线 |
| mvp_大大 | ENTJ/现代都市 | 4.42 | 5.0 | **+13%** |
...
1. **长会话测试**: 50+ 轮深度测试
2. **记忆/自主优化**: 解决当前 2/5 短板
3. **游戏数据深度注入**: 将桥接数据真正注入 CPI 记忆管线
